...
const Waves: React.FC<WavesProps> = ({
    ...
    useEffect(() => {
        ...
        function onMouseMove(e: MouseEvent): void { updateMouse(e.clientX, e.clientY); }
    ...
    return (
        <div
            ...
            className={`waves-container ${className}`.trim()}
        >
            <div
            ...
            <canvas
                ref={canvasRef}
                className="waves-canvas block w-full h-full"
            />
        </div>
    );
};
