    ...
    >
      ...
      <div className="px-6 py-4 max-h-[calc(100vh-200px)] overflow-y-auto">
        <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <div className={`
                        ...
                        ${paymentSchedule === option ? 'border-blue-500' : 'border-gray-500'}
                      `}>
                        {paymentSchedule === option && (
                  ...
                  >
                    <div className="flex items-center space-x-3">
                      <div className={`
                        w-4 h-4 rounded-full border-2 flex items-center justify-center
                        transition-colors duration-200
                        ${approvalStatus === option ? 'border-blue-500' : 'border-gray-500'}
                      `}>
                        {approvalStatus === option && (
                          <div className="w-2 h-2 rounded-full bg-blue-500" />
                        )}
          ...
          {paymentSchedule === 'Installment' && amount && numberOfPayments > 0 && (
            <div className="p-4 bg-gray-800/50 border border-gray-700 rounded-md">
              ...
              <div className="grid grid-cols-2 gap-4 text-sm text-gray-300">
                <p>Amount per payment: ₱{(parseFloat(amount) / numberOfPayments).toFixed(2)}</p>
